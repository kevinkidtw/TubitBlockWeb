...
function registerToolboxs () {
    return `
<category name="%{BKY_TUBITV2V7RC_CATEGORY}" id="TUBITV2V7RC_CATEGORY" colour="#C0C0C0" secondaryColour="#C0C0C0" iconURI="../external-resources/extensions/default_icon.svg">
