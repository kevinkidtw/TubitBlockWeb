...
function registerToolboxs () {
    return `
    <category name="%{BKY_TUBITV2TCS3472_CATEGORY}" id="TUBITV2TCS3472_CATEGORY" colour="#E1AFD1" secondaryColour="#E1AFD1" iconURI="../external-resources/extensions/default_icon.svg">
