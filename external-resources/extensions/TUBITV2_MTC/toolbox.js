...
function registerToolboxs () {
    return `
<category name="%{BKY_TUBITV2_MTC_CATEGORY}" id="TUBITV2_MTC_CATEGORY" colour="#FF6700" secondaryColour="#FF6700" iconURI="../external-resources/extensions/default_icon.svg">
