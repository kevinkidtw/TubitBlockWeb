...
function registerToolboxs () {
    return `
<category name="%{BKY_TUBITV2_VARIABLE_CATEGORY}" id="TUBITV2_VARIABLE_CATEGORY" colour="#59C059" secondaryColour="#59C059" iconURI="../external-resources/extensions/default_icon.svg">
